...
#ifndef _REVEAL_ANALYTICS_SERVICE_HOST_WORKER_H_
#define _REVEAL_ANALYTICS_SERVICE_HOST_WORKER_H_
...
private:
  bool send_valid_handshake_response( Reveal::Core::authorization_ptr auth );
  bool send_invalid_handshake_response( Reveal::Core::authorization_ptr auth );
  bool authorize( Reveal::Core::authorization_ptr auth );
  bool service_failed_authorization( Reveal::Core::authorization_ptr auth );
  bool service_handshake_request( Reveal::Core::authorization_ptr auth );
...
#endif // _REVEAL_ANALYTICS_SERVICE_HOST_WORKER_H_
