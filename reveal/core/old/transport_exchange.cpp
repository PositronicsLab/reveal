...
transport_exchange_c::error_e transport_exchange_c::build( std::string& serialized_message ) {
  ...
  Reveal::Core::Messages::State::Message msg = Reveal::Core::Messages::State::Message();
...
transport_exchange_c::error_e transport_exchange_c::parse( const std::string& serialized_message ) {
  Reveal::Core::Messages::State::Message msg;
  error_e error;
...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::build_authorization( Reveal::Core::Messages::State::Message* msg ) {

//  transport_exchange_c::error_e error;
  Reveal::Core::Messages::State::Message::Header* header = msg->mutable_header();
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::build_client_message( Reveal::Core::Messages::State::Message* msg ) {

  //transport_exchange_c::error_e error;
  Reveal::Core::Messages::State::Message::Header* header = msg->mutable_header();

  header->set_origin( Messages::State::Message::CLIENT );

  if( _type == TYPE_HANDSHAKE ) {
    header->set_type( Messages::State::Message::HANDSHAKE );

  } else if( _type == TYPE_ERROR ) {

  } else if( _type == TYPE_DIGEST ) {
    // digest request
    header->set_type( Messages::State::Message::DIGEST );
    header->set_error( Messages::State::Message::ERROR_NONE );

  } else if( _type == TYPE_EXPERIMENT ) {
    // scenario request
    header->set_type( Messages::State::Message::EXPERIMENT );
    header->set_error( Messages::State::Message::ERROR_NONE );
    ...
    // trial request
    header->set_type( Messages::State::Message::TRIAL );
    header->set_error( Messages::State::Message::ERROR_NONE );
    ...
    header->set_type( Messages::State::Message::SOLUTION );
    header->set_error( Messages::State::Message::ERROR_NONE );
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::build_server_message( Reveal::Core::Messages::State::Message* msg ) {

  //transport_exchange_c::error_e error;
  Reveal::Core::Messages::State::Message::Header* header = msg->mutable_header();

  header->set_origin( Messages::State::Message::SERVER );

  if( _type == TYPE_HANDSHAKE ) {
    header->set_type( Messages::State::Message::HANDSHAKE );

  } else if( _type == TYPE_ERROR ) {
    header->set_type( Messages::State::Message::ERROR );
    ...
    if( error == ERROR_BAD_SCENARIO_REQUEST ) {
      header->set_error( Messages::State::Message::ERROR_BAD_SCENARIO );
    } else if( error == ERROR_BAD_TRIAL_REQUEST ) {
      header->set_error( Messages::State::Message::ERROR_BAD_TRIAL );
    } else {
      header->set_error( Messages::State::Message::ERROR_GENERAL );
    }
    ...
    header->set_type( Messages::State::Message::STEP );
  } else if( _type == TYPE_EXIT ) {
    header->set_type( Messages::State::Message::EXIT );
  } else {
    _error = ERROR_BUILD;
    return ERROR_BUILD;
  }
...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::map_origin( Reveal::Core::Messages::State::Message* msg ) {
  //transport_exchange_c::error_e error;

  if( msg->header().origin() == Messages::State::Message::SERVER ) {
    _origin = ORIGIN_SERVER;
  } else if( msg->header().origin() == Messages::State::Message::CLIENT ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::map_type( Reveal::Core::Messages::State::Message* msg ) {
  //transport_exchange_c::error_e error;

  if( msg->header().type() == Messages::State::Message::ERROR ) {
    _type = TYPE_ERROR;
  } else if( msg->header().type() == Messages::State::Message::HANDSHAKE ) {
    _type = TYPE_HANDSHAKE;
  } else if( msg->header().type() == Messages::State::Message::DIGEST ) {
    _type = TYPE_DIGEST;
  } else if( msg->header().type() == Messages::State::Message::EXPERIMENT ) {
    _type = TYPE_EXPERIMENT;
  } else if( msg->header().type() == Messages::State::Message::TRIAL ) {
    _type = TYPE_TRIAL;
  } else if( msg->header().type() == Messages::State::Message::SOLUTION ) {
    _type = TYPE_SOLUTION;
  } else if( msg->header().type() == Messages::State::Message::STEP ) {
    _type = TYPE_STEP;
  } else if( msg->header().type() == Messages::State::Message::EXIT ) {
    _type = TYPE_EXIT;
  } else {
    // UNDEFINED
    // set error
...
/*
  if( _type == TYPE_ERROR )
    ...
    // if( proto.header().error() == Messages::State::Message::ERROR_? ) {
    //   _error = ERROR_?
    // } else if( ... ) {
    // }
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::map_authorization( Reveal::Core::Messages::State::Message* msg ) {
  //transport_exchange_c::error_e error;
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::map_client_message( Reveal::Core::Messages::State::Message* msg ) {
  //transport_exchange_c::error_e error;
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::map_server_message( Reveal::Core::Messages::State::Message* msg ) {
  //transport_exchange_c::error_e error;

  if( _type == TYPE_ERROR ) {
    // TODO : cross reference errors
    Messages::State::Message::Error msg_error = msg->header().error();
    if( msg_error == Messages::State::Message::ERROR_BAD_SCENARIO ) {
      _error = ERROR_BAD_SCENARIO_REQUEST;
    } else if( msg_error == Messages::State::Message::ERROR_BAD_TRIAL ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::write_digest( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::read_digest( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::write_scenario( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::read_scenario( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::write_experiment( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::read_experiment( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::write_trial( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::read_trial( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::write_solution( Reveal::Core::Messages::State::Message* msg ) {
...
//----------------------------------------------------------------------------
transport_exchange_c::error_e transport_exchange_c::read_solution( Reveal::Core::Messages::State::Message* msg ) {
