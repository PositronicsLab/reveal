...
#ifndef _REVEAL_SAMPLES_CLIENT_H_
#define _REVEAL_SAMPLES_CLIENT_H_
...
public:
  ...
  /// Default Constructor
  client_c( std::string samples_server_uri );
  /// Destructor
...
//  Reveal::Core::connection_c _connection;//< the reveal client/server connection
  ...
  Reveal::Sim::sim_interface_c _interface;
...
#endif // _REVEAL_SAMPLES_CLIENT_H_
