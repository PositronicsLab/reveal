...
#include <Reveal/messages/state.pb.h>
...
private:
  ...
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e build_authorization( Reveal::Core::Messages::State::Message* message );

  /// Builds a client message
  /// @param message the message to build into
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e build_client_message( Reveal::Core::Messages::State::Message* message );

  /// Builds a server message
  /// @param message the message to build into
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e build_server_message( Reveal::Core::Messages::State::Message* message );

  /// Maps the origin of a message to the instance variables
  /// @param message the message to map
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e map_origin( Reveal::Core::Messages::State::Message* message );

  /// Maps the type of a message to the instance variables
  /// @param message the message to map
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e map_type( Reveal::Core::Messages::State::Message* message );

  /// Maps the authorization of a message to the instance variables
  /// @param message the message to map
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e map_authorization( Reveal::Core::Messages::State::Message* message );

  /// Maps a client message to appropriate instance variables
  /// @param message the message to map
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e map_client_message( Reveal::Core::Messages::State::Message* message );

  /// Maps a server message to appropriate instance variables
  /// @param message the message to map
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e map_server_message( Reveal::Core::Messages::State::Message* message );

  /// Writes the class digest reference into a message
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e write_digest( Reveal::Core::Messages::State::Message* message );

  /// Reads the message digest into the class digest reference
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e read_digest( Reveal::Core::Messages::State::Message* message );

  /// Writes the class scenario reference into a message
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e write_scenario( Reveal::Core::Messages::State::Message* message );

  /// Reads the message scenario into the class digest reference
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e read_scenario( Reveal::Core::Messages::State::Message* message );

  /// Writes the class experiment reference into a message
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e write_experiment( Reveal::Core::Messages::State::Message* message );

  /// Reads the message experiment into the class digest reference
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e read_experiment( Reveal::Core::Messages::State::Message* message );

  /// Writes the class trial reference into a message
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e write_trial( Reveal::Core::Messages::State::Message* message );

  /// Reads the message trial into the class digest reference
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e read_trial( Reveal::Core::Messages::State::Message* message );

  /// Writes the class solution reference into a message
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e write_solution( Reveal::Core::Messages::State::Message* message );

  /// Reads the message solution into the class digest reference
  /// @param message the message to write to
  /// @return returns ERROR_NONE on successfully building the message OR another
  ///         enumerated error value indicating the error that occurred
  error_e read_solution( Reveal::Core::Messages::State::Message* message );
};
